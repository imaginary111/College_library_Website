...
<div id="mainContentUp" class="row">
    ...
    <div class="collection card">
      <a class="collection-item grey-text text-darken-3" href="http://dlist.sir.arizona.edu/">Digital Library of Information Science and Technology (DLIST)<i class="mdi-action-class small grey-text text-darken-1 left"></i></a>
      <a class="collection-item grey-text text-darken-3" href="http://www.doabooks.org/">Directory of Open Access Books<i class="mdi-action-class small grey-text text-darken-1 left"></i></a>
      <a class="collection-item grey-text text-darken-3" href="http://www.ebooks4free.net/">Ebook4free.net<i class="mdi-action-class small grey-text text-darken-1 left"></i></a>
      <a class="collection-item grey-text text-darken-3" href="http://www.free-books.org/">Free-Books.org<i class="mdi-action-class small grey-text text-darken-1 left"></i></a>
      <a class="collection-item grey-text text-darken-3" href="http://www.freefictionbooks.org/">Free Fiction Books<i class="mdi-action-class small grey-text text-darken-1 left"></i></a>
      <a class="collection-item grey-text text-darken-3" href="http://www.gutenberg.org/">Project Gutenberg<i class="mdi-action-class small grey-text text-darken-1 left"></i></a>
    </div>
  </div>
